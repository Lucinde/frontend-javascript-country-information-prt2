...
async function getCountries(search) {
    ...
    warning.innerText = "";
    try {
        const response = await (0, _axiosDefault.default).get(`https://restcountries.com/v2/name/${search}`);
...
function getCurrency(data) {
    ...
    if (data.length === 2) return currencyMessage + `${data[0].name}'s and ${data[1].name}'s`;
    return currencyMessage + `${data[0].name}'s`;
}
function getLanguage(data) {
    let languageMessage = `They speak `;
    if (data.length === 2) return languageMessage + `${data[0].name} and ${data[1].name}`;
    if (data.length === 3) return languageMessage + `${data[0].name}, ${data[1].name} and ${data[2].name}`;
    if (data.length === 4) return languageMessage + `${data[0].name}, ${data[1].name}, ${data[2].name}, and ${data[3].name}`;
    if (data.length > 4) return languageMessage + `${data[0].name}, ${data[1].name}, ${data[2].name}, ${data[3].name} and even more languages!`;
...
submitForm.addEventListener("submit", function(event) {
    ...
    getCountries(searchField.value);
    searchField.value = "";
});
...
var Buffer = require("f79dd153d250fc94").Buffer;
"use strict";
/**
...
},{"f79dd153d250fc94":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("251023c18d93631e");
var ieee754 = require("f94ed213e6ecea30");
...
},{"251023c18d93631e":"eIiSV","f94ed213e6ecea30":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
